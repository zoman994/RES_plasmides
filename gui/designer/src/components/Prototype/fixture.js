...
export const fixture = {
  ...
  annotations: [
    ...
    { id: 'a03', type: 'CDS',           name: '6×His',             start:  920, end:  944, strand:  1, level: 'region' },
    { id: 'a04', type: 'CDS',           name: '3×FLAG',            start:  944, end: 1010, strand:  1, level: 'region' },
    { id: 'a05', type: 'CDS',           name: 'GS-linker',         start: 1010, end: 1055, strand:  1, level: 'region' },
    ...
    { id: 'a10', type: 'primer_bind',   name: 'M13/pUC seq-rev',   start: 3700, end: 3720, strand: -1, level: 'region' },
    { id: 'a11', type: 'protein_bind',  name: 'lac operator',      start: 3750, end: 3775, strand:  1, level: 'region' },
    { id: 'a12', type: 'protein_bind',  name: 'CAP binding site',  start: 3800, end: 3825, strand:  1, level: 'region' },
    ...
    { id: 'a15', type: 'sig_peptide',   name: 'IgG leader',        start: 4450, end: 4515, strand:  1, level: 'region' },
