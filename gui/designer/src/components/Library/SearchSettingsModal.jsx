...
const ITEMS = [
  ...
  {
    key: 'iupac', label: 'Неоднозначные коды (IUPAC)', kind: 'enum', options: ['auto', 'on', 'off'],
    help: 'Трактовать N/R/Y… как совместимость: запрос GAANTC найдёт GAATTC. «auto» — включать, если такие буквы есть в запросе.',
  },
  {
  ...
  {
    key: 'maxMismatches', label: 'Допуск несовпадений', kind: 'int', min: 0, max: 5, step: 1,
    help: 'Сколько несовпадений допустить в коротком точном поиске (0 — только точные/совместимые).',
  },
  {
